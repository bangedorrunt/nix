;;; core/autoload/doom/buffers.el -*- lexical-binding: t; -*-
...
(defalias 'doom-project-buffer-list #'project-list-buffers)
;;;###autoload
...
;;;###autoload
(defalias 'doom/kill-project-buffers #'project-kill-buffers)

(provide 'doom '(buffers))
