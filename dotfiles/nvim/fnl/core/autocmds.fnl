...
(augroup packer_compile
  (autocmd!)
  (autocmd BufWritePost */plugins/init.fnl
           '(vim.cmd "PackerCompile profile=true"))
  (autocmd VimLeavePre [*/plugins/init.fnl */plugins/**/*.fnl]
           '(vim.cmd "PackerCompile profile=true")))
...
(augroup disable_colorcolumn_on_filetypes
  (autocmd!)
  (autocmd FileType [help packer NvimTree fern fennel clojure lisp markdown]
