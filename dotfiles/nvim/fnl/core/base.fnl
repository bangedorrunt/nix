          ...
          {:ft {:conjure [:clojure :fennel :lisp :lua :rust]}
           ...
           :cmp {:menu-items {:nvim_lsp :LSP
                 ...
                 :sources [{:name :nvim_lsp}
                           ...
                           {:name :nvim_lua}
                           {:name :calc}]}
           :treesitter {:languages [:bash :fish
                                    :comment
                                    :clojure
                                    :commonlisp
                                    :fennel
           ...
           :paths {:is-mac? (= os-name :Darwin)
                   ...
                   :data data-path
                   :state state-path
                   :treesitter (.. share-path :/treesitter)
                   :packer (.. data-path :pack/packer/opt/packer.nvim)
                   :packer-compiled (.. data-path :lua/packer_compiled.lua)}}))
