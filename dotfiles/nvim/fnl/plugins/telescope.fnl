...
(noremap n nowait "<Leader><Leader>" (viml->keymap project-files))
(noremap n nowait "<Leader>;"        (viml->keymap live-grep))
(noremap n nowait "<Leader>*"        (viml->keymap grep-string))
(noremap n nowait "<Leader>0"        (viml->keymap nvim-files))
(noremap n nowait "<Leader>9"        (viml->keymap nix-files))
(noremap n nowait "<Leader>sg"       (viml->keymap git-files))
(noremap n nowait "<Leader>sb"       (viml->keymap buffers))
(noremap n nowait "<Leader>so"       (viml->keymap oldfiles))
(noremap n nowait "<Leader>sc"       (viml->keymap commands))
(noremap n nowait "<Leader>sC"       (viml->keymap command-history))
(noremap n nowait "<Leader>sk"       (viml->keymap keymaps))
(noremap n nowait "<Leader>sr"       (viml->keymap resume))
