...
(ins_left {1 #("") :color {:fg colors.blue} :padding {:left 0 :right 1}})

(ins_left {1 #("")
           :color #(let [mode-color {:n colors.red
                                     :i colors.green
                                     :v colors.blue
                                     "''" colors.orange
                                     :V colors.blue
...
(ins_right {1 #("") :color {:fg colors.blue} :padding {:left 1}})
